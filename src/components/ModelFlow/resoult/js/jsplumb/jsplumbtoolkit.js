(function() {
    ...
    var a = this,
      ...
      B = function(a, b, c, d) {
        ...
        this.downListener = function(a) {
          if ((this.rightButtonCanDrag || 3 !== a.which && 2 !== a.button) && this.isEnabled() && this.canDrag())
            if (P(a) && x(a, this.el, this.k)) {
              if (v) {
                t = this.el.cloneNode(!0), t.setAttribute("id", null), t.style.position = "absolute";
                var b = f(this.el);
                t.style.left = b.left + "px", t.style.top = b.top + "px", this.params.addClass(t, p.clonedDrag), document.body.appendChild(t)
              } else t = this.el;
          ...
          if (k) {
            if (!q) {
              if (!1 !== V("start", { el: this.el, pos: l, e: a, drag: this })) {
                if (!k) return;
                this.mark(!0), q = !0
              } else this.abort()
            }
        ...
        this.notifyStart = function(a) {
          V("start", { el: this.el, pos: this.params.getPosition(t), e: a, drag: this })
          ...
          if (b || q) {
            ...
            if (d.length > 1)
              ...
              } else c.push([t, { left: e[0], top: e[1] }, this]);
            V("stop", { el: t, pos: W || e, finalPos: e, e: a, drag: this, selection: c })
          }
    ...
    a.Katavorio = function(a) {
      ...
      this.getInputFilterSelector = function() {
        ...
        a.posses && v(a.posses, function(b) {
          a.posseRoles[b] && z[b] && t(z[b].members, function(a) {
            a.mark()
          }, a)
        })
        ...
        a.posses && v(a.posses, function(c) {
          a.posseRoles[c] && z[c] && t(z[c].members, function(a) {
            a.unmark(b, !0)
          }, a)
        })
      ...
      var w = function(a, b) {
        b.posses && v(b.posses, function(c) {
          b.posseRoles[c] && z[c] && t(z[c].members, function(b) {
            a(b)
          }, b)
        })
      };
      ...
      this.elementRemoved = function(a) {
        ...
        this._dragsByScope = {}, this._dropsByScope = {}, f = [], g = {}, z = {}
      };
      var z = {},
        A = function(a, c, d) {
          var f = e(c) ? c : c.id,
      ...
      this.addToPosse = function(a, b) {
        for (var c = [], d = 1; d < arguments.length; d++) c.push(A(a, arguments[d]));
        return 1 === c.length ? c[0] : c
      }, this.setPosse = function(a, b) {
        for (var c = [], e = 1; e < arguments.length; e++) c.push(A(a, arguments[e], !0).name);
        return v(a, function(a) {
          if (a._katavorioDrag) {
        ...
        for (var d = 1; d < arguments.length; d++) b = arguments[d], v(a, function(a) {
          if (a._katavorioDrag && a._katavorioDrag.posses) {
            ...
            v(b, function(a) {
              c(z[a].members, d), c(d.posses, a), delete d.posseRoles[a]
            })
          }
        })
  ...
  function() {
    ...
    var m = 0,
      ...
      o = a.jsPlumbInstance = function(d) {
        this.version = "2.6.7", d && p.extend(this.Defaults, d), this.logEnabled = this.Defaults.LogEnabled, this._connectionTypes = {}, this._endpointTypes = {}, b.EventGenerator.apply(this);
        var f = this,
          g = n(),
          h = f.bind,
          j = {},
          ...
          if (null != e) {
            ...
            if (null == f) {
              var j = a.dimensions || d.s,
                k = { xy: [e.left, e.top], wh: j, element: this, timestamp: b };
  ...
  function() {
    ...
    b.Connection = function(a) {
      ...
      e.manage(this.sourceId, this.source), e.manage(this.targetId, this.target), this._jsPlumb.visible = !0, this._jsPlumb.editable = !0 === a.editable, this._jsPlumb.params = {
        cssClass: a.cssClass,
        container: a.container,
        ...
        this.setHover(!1)
      }.bind(this)), this.editableRequested = !1 !== a.editable, this.setEditable = function(a) {
      ...
      repaint: function(a) {
        a = a || {}, this.paint({ elId: this.sourceId, recalc: !(!1 === a.recalc), timestamp: a.timestamp })
      },
    ...
    c.AnchorManager = function(a) {
      ...
      this.updateOtherEndpoint = function(a, d, e, f) {
        ...
        if (!m.isSuspendDrawing()) {
          ...
          for (x = 0; x < k.length; x++) k[x].paint({ timestamp: f, offset: t, dimensions: t.s, recalc: !0 !== i });
  ...
  function() {
    ...
    b.Connectors.AbstractConnector = function(a) {
      ...
      var f = [],
        ...
        r = null,
        s = null,
        t = !1 !== a.editable && null != b.ConnectorEditors && null != b.ConnectorEditors[this.type],
            ...
            var x = a.startStubX + (a.endStubX - a.startStubX) * h,
              ...
              A = {
                ...
                opposite: function(c, d, e, f) {
                  ...
                  return !k || 1 === h.so[q] && d > f || -1 === h.so[q] && d < f ? {
                    x: [
                      [d, y],
                      [f, y]
                    ],
  ...
  function() {
    ...
    var d = function(a) {
      ...
      this._findControlPoint = function(a, b, c, f, g, h, i) {
        ...
        if(j){
          console.log('----反过来了---')
          0 === i[0] ? k.push(c[0] < b[0] ? a[0] + e : a[0] - e) : k.push(a[0] + d * i[0])
          0 === i[1] ? k.push(c[1] < b[1] ? a[1] + e : a[1] - e) : k.push(a[1] + d * h[1])
        }else{
          0 === h[0] ? k.push(b[0] < c[0] ? a[0] + e : a[0] - e) : k.push(a[0] - d * h[0])
      ...
      this._computeBezier = function(a, b, d, e, f, g) {
        var h, i, j = this.getGeometry(),
          ...
          m = d[0] < e[0] ? 0 : f,
          n = d[1] < e[1] ? 0 : g;
        if((this.hasBeenEdited() || this.isEditing()) && null != j && null != j.controlPoints && null != j.controlPoints[0] && null != j.controlPoints[1]){
          h = j.controlPoints[0]
          i = j.controlPoints[1]
        }else{
          h = this._findControlPoint([k, l], d, e, b.sourceEndpoint, b.targetEndpoint, a.so, a.to)
  ...
  function() {
    ...
    b.Connection.prototype.animateOverlay = function(a, f) {
      ...
      if ("string" == typeof a) l = [a, { location: v, id: m }];
      else {
        var A = b.extend({}, a[1]);
    ...
    var c = function(a, b) {
      ...
      g = b.Vertex = b.Node = function(a, d, g) {
        ...
        this.setDefaultInternalCost = function(a) {
          ...
          var c = o(a),
            d = o(b),
            e = { source: n[c], target: n[d], cost: 1 / 0 };
      ...
      l = (b.Graph = function(a) {
        ...
        this.clear = function() {
          ...
          a = z(a);
          var b = p.compute({ graph: this, source: a, target: a, processAll: !0 }),
            c = 0;
  ...
  function() {
    ...
    a.jsPlumbToolkitInstance = function(i) {
      ...
      var T = this.findGraphObject = function(a) {
        ...
        U = function(a, b, c) {
          ...
          var d = [],
            ...
            h = function(d, f, h, i) {
              if (null != d)
                for (var j = d[b]({ filter: a.filter }), k = 0; k < j.length; k++) {
      ...
      if (this.render = function(e, f) {
          ...
          var e = { els: {}, obj: null, type: null, id: null, el: null },
            f = function(a) {
  ...
  function() {
    ...
    b.mouseEvents = ["click", "dblclick", "contextmenu", "mousedown", "mouseup", "mousemove", "mouseenter", "mouseleave", "mouseover"], b.createElement = function(a, b) {
      var c = { width: a.width, height: a.height, position: a.position || k.absolute },
        d = {};
    ...
    var m = b.DOMElementAdapter = function(a) {
      ...
      n = b.AbstractRenderer = function(a) {
        ...
        function n(a, b) {
          if (b.events)
            for (var c in b.events) Q.on(a, c, b.events[c])
        }
        ...
        function o(a, b, c) {
          if (null == a.value("jtk-processed")) {
            ...
            if ("true" === a.value("is-source") && (d.isSource = !0), delete d.uniqueEndpoint, delete d.createEndpoint, d.extract = {}, a.findDataValues(d.extract), "true" === a.value("endpoint")) {
              ...
              (a.element._katavorioDrop ? a.element._katavorioDrop.length : 0) > k && (j = a.element._katavorioDrop[a.element._katavorioDrop.length - 1]), A.onUpdate(a.element, function(a, c) {
        ...
        function s(a, b, c) {
          var d = fa(a);
          if (d) {
            (!b || q(d)) && (d.setVisible(b), c || (r(d, d.endpoints[0], b), r(d, d.endpoints[1], b)))
          }
        }
        ...
        var v = function(a, b) {
          ...
          w = '<div data-jtk-node-id="${id}" class="' + j.NODE + '"></div>',
          x = {
            rotors: {
              render: function(a, b) {
          ...
          B = this,
          C = a.toolkit,
          D = new c.Layouts.EmptyLayout(B),
          E = f.getElement(a.container),
          F = !(!1 === a.elementsDraggable),
          G = !0 === a.elementsDroppable,
          H = !1,
          I = !1 !== a.refreshAutomatically,
          J = a.templateRenderer ? e.isString(a.templateRenderer) ? x[a.templateRenderer] : { render: a.templateRenderer } : x[y],
          K = !1 !== a.enhancedView,
          L = a.assignPosse || function() {
            return null
          },
          M = a.modelLeftAttribute || "left",
          N = a.modelTopAttribute || "top",
          O = !1 !== a.storePositionsInModel,
          P = e.merge(a.jsPlumb || {}),
          Q = a.jsPlumbInstance || f.getInstance(P, a.overrideFns),
          R = Q.getId(E);
        Q.bind("beforeDrop", function(a) {
          ...
          return !1 === e && a.endpoint.isTemporarySource && a.endpoint._deleteOnDetach && Q.deleteEndpoint(a.endpoint), e
        ...
        if (this.setHoverSuspended = Q.setHoverSuspended, this.isHoverSuspended = Q.isHoverSuspended, this.setJsPlumbDefaults = function(a) {
            ...
            -1 == S.indexOf(a) ? U(a, b) : T(a, b)
          }, a.events)
          for (var V in a.events) this.bind(V, a.events[V]);
        if (a.interceptors)
          for (var W in a.interceptors) this.bind(W, a.interceptors[W]);
        var X = !1;
        U(l.connection, function(a) {
          if (null == a.connection.edge) {
            ...
            !1 === C.getEdgeFactory()(d, a.connection.getData() || {}, function(b) {
              k.edge = C.addEdge({
                source: i,
                target: j,
            ...
            }) && Q.deleteConnection(a.connection)
          }
        ...
        var ea = {},
          ...
          ia = function(a, b, c) {
            if (!c.getParameter("edge")) {
              ...
              if (d && d.events)
                for (var e in d.events) ha(e, d.events[e], b, c)
            }
          },
          ja = function(a) {
            B.fire(l.edgeRemoved, {
        ...
        if (!1 !== this.bindToolkitEvents) {
          ...
          var oa = function(a, b, c) {
              var d = _[c.id];
              if (d) {
                (d.querySelector("[jtk-group-content]") || d).appendChild(a), Q.addToGroup(c.id, a, !0), B.nodeAppendedToGroup(a, d, c)
              }
            },
            pa = function(a, b) {
              var c = Y[a.id];
              if (null == c) {
                if (!0 === va.getNodeDefinition(C.getNodeType(a.data)).ignore) return !1;
                if (!(c = Aa(a, a.data, a))) throw new Error("Cannot render node");
                var d = Q.getId(c);
                Y[a.id] = c, Z[d] = a, ca.push(a), c.jtk = { node: a }, null == a.group ? B.append(c, d, b ? b.position : null) : oa(c, a, a.group), ka(c, a), Ka(c, a);
                var e = { node: a, el: c, id: a.id };
                B.getLayout().nodeAdded(e, b), B.fire(l.nodeAdded, e)
              }
              return c
            };
          ...
          var ra = function(b, c) {
            ...
            if (null == d) {
              ...
              if (!(d = Ca(b, b.data, b))) throw new Error("Cannot render Group");
              var h = Q.getId(d);
              ...
              f.extend(j, { dragOptions: a.dragOptions || {} }), j.dragOptions[f.dragEvents[k.stop]] = e.wrap(j.dragOptions[f.dragEvents[k.stop]], function(a) {
                a.el.jtk && a.el.jtk.group && (j.dragOptions.magnetize ? a.pos = B.getLayout().setMagnetizedPosition(a.el.jtk.group.id, a.pos[0], a.pos[1], !0) : B.getLayout().setPosition(a.el.jtk.group.id, a.pos[0], a.pos[1], !0), !1 !== O && (B.storePositionInModel({
          ...
          C.bind(l.groupAdded, function(a) {
            var b = a.group;
            null != ra(b, a.eventInfo) && B.refresh(!0)
          ...
          var ua = function(b, c) {
            return function() {
              ...
              !1 !== Y[h.id]._jtkVisible && !1 !== g._jtkVisible || s(b, !1)
            }
          };
          C.bind(l.edgeAdded, function(b) {
            if (!X && b.source !== B) {
              var c = b.edge,
                d = va.getEdgeDefinition(C.getEdgeType(c.data || {}));
            ...
            Q.reset(!0);
            for (var a in _) void 0 !== _[a]._rotors && A.remove(_[a]), _[a].parentNode && _[a].parentNode.removeChild(_[a]);
            for (var b in Y) void 0 !== Y[b]._rotors && A.remove(Y[b]), Y[b].parentNode && Y[b].parentNode.removeChild(Y[b]);
            D && D.clear(), ca.length = 0, aa.length = 0, ea = {}, Y = {}, _ = {}, Z = {}, ba = {}, $ = {}, Ea = {}, B.getZoom && Q.setZoom(B.getZoom())
          }), C.bind(l.portAdded, function(a) {
            var b = Y[a.node.id] || _[a.node.id];
            if (va.getPortDefinition(C.getPortType(a.data)).isEndpoint) m(new Ja(a.data, b, a.port), a.node);
            else {
              var c = Ba(a.port, a.data, a.node);
              $[a.node.id + C.getGraph().getPortSeparator() + a.port.id] = c, Ka(Q.getElement(c), a.node), B.fire(l.portAdded, {
                node: a.node,
                nodeEl: b,
                port: a.port,
                portEl: c
        ...
        this.initialize = function() {
          ...
          if (C.setSuspendGraph(!0), Q.setSuspendDrawing(!0), a.jsPlumbInstance) {
            ...
            for (var g in c) {
              var h = c[g].el;
              Y[h.jtk.node.id] = h, Z[a.jsPlumbInstance.getId(h)] = h.jtk.node
            }
            ...
            for (b = 0, d = C.getNodeCount(); b < d; b++)
              if (c = C.getNodeAt(b), Y[c.id]) {
                var i = C.getAllEdgesFor(c);
                for (f = 0; f < i.length; f++)
                  if (i[f].source == c || i[f].source.getNode && i[f].source.getNode() == c) {
                    var j = va.getEdgeDefinition(C.getNodeType(i[f].data));
                    if (j && !0 === j.ignore) continue;
                    var k = ya(i[f]);
                    k.doNotFireConnectionEvent = !0;
                    var l = Q.connect(k);
                    null != l && (l.edge = i[f], ea[i[f].getId()] = l, ia(k.type, i[f], l))
                  }
              }
          }
        ...
        var Ea = {},
          ...
          Ha = function(a, b, c) {
            var g = a.value("port-id"),
              ...
              i = a.value("scope") || Q.getDefaultScope(),
              j = C.getNodeType(b),
              k = va.getNodeDefinition(j),
              l = va.getPortDefinition(g, k),
              m = va.getPortDefinition(h, k),
              n = e.merge(m, l),
            ...
            if (o.connectionType = r, o.portId = g, o.portType = h, o.scope = i, o.parameters = o.parameters || {}, o.parameters.portId = g, o.parameters.portType = h, o.parameters.edgeType = r, o.parameters.scope = i, o.parameters.nodeId = b.id, o.events = {}, n.events)
              for (v in n.events) o.events[v] = p(n.events[v]);
            if (n.interceptors)
              for (v in n.interceptors) o[v] = q(n.interceptors[v]);
        ...
        this.setPosition = function(a, b, c, d) {
          ...
          if (null != a) {
            var d = function(a, d) {
                if (d && (d.style.display = b ? "block" : "none", d._jtkVisible = b, B.fire(l.nodeVisibility, {
                  ...
                  for (var e = C.getAllEdgesFor(a), f = 0; f < e.length; f++) s(e[f], b, c)
              },
              e = function(a) {
                var c = a.getFullId();
                Ea[c].setVisible(b)
          ...
          d.each(a, function(a) {
            var d = u(a);
            d.el && Q.addToPosse(d.el, { id: b, active: !1 !== c })
          })
        }, this.setPosse = function(a, b) {
          d.each(a, function(a) {
            var c = u(a);
  ...
  function() {
    ...
    var b = this,
      ...
      f = "wheelDeltaX",
      g = {
        webkit: { mac: a(c, 120), win: a(c, 100) },
        safari: function(b) {
          return a(e, 120, !0)
        },
        firefox: {
      ...
      h = {
        webkit: { mac: a(d, 120), win: a(d, 100) },
        safari: function(b) {
          return a(f, 120, !0)
        },
        firefox: {
  ...
  function() {
    ...
    this.ZoomWidget = function(a) {
      ...
      var i, j, k, l, m, n, o = this,
        ...
        D = a.panDistance || 50,
        E = !1 !== a.enablePan,
        F = !1 !== a.enableWheelZoom,
        G = !1 !== a.enableAnimation,
        H = a.wheelFilter || function() {
          return !0
        },
        I = !0 === a.wheelZoomMetaKey,
        J = !0 === a.wheelReverse ? -1 : 1,
        K = J * (a.wheelSensitivity || 10),
        L = !0 === a.wheelPan,
        M = !1 !== a.enablePanButtons,
        N = a.padding || [0, 0],
        O = !1 !== a.consumeRightClick,
      ...
      this.setBoundsFor = ta, this.setSuspendRendering = function(a) {
        Q = a, !a && ra && sa(), ra = !1
      };
      var ua = function(a, b) {
          return function(c) {
            Va(s, a * D, b * D, null, !0, function(a) {
              w(a[0], a[1], da, da, c), i && i.pan(), jb.pan()
            })
          }
        },
        va = 150,
        ...
        Ba = function(b, c, d) {
          return function() {
            Aa = d, a.addClass(Aa, "jtk-surface-pan-active"), a.bind(document, "mouseup", Ca), ya = window.setTimeout(function() {
              a.bind(document, S, Ea), za = window.setInterval(Da(b, c), wa)
            }, va)
          }
        },
        Ca = function() {
          window.clearTimeout(ya), Aa && a.removeClass(Aa, "jtk-surface-pan-active"), Aa = null
        },
        Da = function(a, b) {
          return function(c) {
            var d = Va(s, a * xa, b * xa, null);
            w(d[0], d[1], da, da, c), i && i.pan(), jb.pan()
          }
        },
        Ea = function() {
          window.clearTimeout(za)
        },
        Fa = function(b, c, d, e, f) {
          var g = document.createElement("div");
          g.innerHTML = f || "", g.style.position = "absolute";
          for (var h in c) g.style[h] = c[h];
          return g.className = "jtk-surface-pan jtk-surface-pan-" + b, u.appendChild(g), a.bind(g, "click", ua(d, e)), a.bind(g, "mousedown", Ba(d, e, g)), g
        };
      M
      var Ga = function(a, b, c) {
        ...
        Ha = function(a) {
          Ga("transformOrigin", ea[0] + "% " + ea[1] + "%", a)
        },
        Ia = function(b, c) {
        ...
        Ja = function(a, b, c, d) {
          var e, f, g, h, i = ea[0] / 100 * b,
            j = ea[1] / 100 * c;
          e = -i * (1 - da), f = -j * (1 - da), ea = a, Ha(), i = ea[0] / 100 * b, j = ea[1] / 100 * c, g = -i * (1 - da), h = -j * (1 - da);
          var k = Va(s, g - e, h - f, d);
          A && A(ea, k)
        },
        Ka = function(a, b, c) {
          var d = Ia(a, b);
        ...
        Ma = function(b, c) {
          var d = a.width(q),
            e = a.height(q);
          Ja([b / d * 100, c / e * 100], d, e)
        },
        Na = this.pageLocation = function(a) {
            ...
            if (a > ja[1] && (a = ja[1]), e) {
              var j = a > da ? .05 : -.05,
                ...
                m = window.setInterval(function() {
                  k = Qa(k + j), l && k <= a && window.clearInterval(m), !l && k >= a && window.clearInterval(m)
                });
              return da
            }
            Ga("transform", "scale(" + a + ")");
            var n = da;
            if (da = a, f || v(ba, ca, da, n, b, c), null != i && i.setZoom(a), jb && jb.pan(), C) {
              var o = Ua(s),
                p = Ta(o[0], o[1]);
              p[0] == o[0] && p[1] == o[1] || Ua(s, p[0], p[1], null, !e)
            }
            return da
          }
        },
        ...
        Xa = {
          start: function(b, c) {
            if (!ga) {
              ...
              X && (d === s || d === u || d._jtkDecoration || i && i.owns(d) || !0 === $(d, b)) && (ia = !1, la = -1, ma = -1, 3 !== b.which || !1 === a.enableWheelZoom || null != b.mozInputSource && 1 !== b.mozInputSource ? c.length <= 1 && (fa = !0, j = Na(b), n = Ua(s)) : (ha = !0, j = Na(b), La(b), n = Ua(s), k = da)), x(b, o)
            }
          },
          move: function(a, b) {
            var c, d, e;
            if (ia = !1, !ga) {
              if (ha) e = Na(a), c = e[0] - j[0], d = e[1] - j[1], Ra(c, d, a);
              else if (fa && E && null != j) {
                e = Na(a), c = e[0] - j[0], d = e[1] - j[1];
                var f = Ua(s, n[0] + c, n[1] + d, a, !0);
                w(f[0], f[1], da, da, a), i && i.pan(), jb && jb.pan()
              }
              z(a, o)
            }
          },
          end: function(a, b) {
            ga || (ha = !1, j = null, fa = !1, ia = !1, W(document, T, Za), W(document, S, $a), V(document, T, _a), y(a, o))
          },
      ...
      V(document, T, _a);
      var ab = this.start = function(a) {
        X && null != a && (W(document, T, _a), V(document, T, Za), V(document, S, $a), Xa.start(a, Pa(a)))
      };
      if (V(t, R, ab), V(t, "contextmenu", function(a) {
          Ya("contextmenu", a)
        }), F) {
        var bb = function(a, b, c, d) {
          ...
          cb = function(a, b, c) {
            k = da, ia || (La(a), ia = !0), Ra(0, a.normalizedWheelDelta * K, a, !0)
          },
          db = function(a, b, c, d) {
            H(a) && (a.preventDefault && a.preventDefault(), a.stopPropagation && a.stopPropagation(), !L || d ? cb(a, b, c, d) : bb(a, b, c, d))
          };
        addWheelListener(u, db, !0, I)
      }
      new PinchListener({
        el: t,
        bind: V,
        ...
        onPinch: function(a, b, c, d) {
          ...
          var e = a[0] - j[0],
            f = a[1] - j[1];
          Ua(s, n[0] + e, n[1] + f, null, !0)
        },
        onPinchStart: function(a, b) {
          ga = !0, j = a, l = m = b, k = da, Ka(j[0], j[1]), n = Ua(s)
        },
        onPinchEnd: function() {
          ga = !1, j = null
        }
      }), Qa(da, null, !1, !1, !0), Ha(), this.isPinchZooming = function() {
        return ga
        ...
        this.positionChanged(a, c, b), d && (V(a, R, ab), a._jtkDecoration = !0)
        ...
        na.minx.length = 0, na.miny.length = 0, na.maxx.length = 0, na.maxy.length = 0, oa = {}, pa = {}, qa = {}, Ua(s, 0, 0, null, !0)
      }, this.getBoundsInfo = d, this.zoomToFit = function(a) {
        a = a || {};
        var b = d(a.padding, a.fill);
        a.doNotZoomIfVisible && b.z > da || Qa(b.z), o.centerContent({
          bounds: b,
        ...
        var i = a.fill || .9;
        c.w = i * (c.xMax - c.x), c.h = i * (c.yMax - c.y), c.z = Math.min(c.vw / c.w, c.vh / c.h), b.doNotZoomIfVisible && c.z > da || Qa(c.z), o.centerContent({
          bounds: c,
        ...
        if (null != i) {
          var b = a.split(" "),
            ...
            j = Wa();
          Ua(s, g - j[0], h - j[1]), i.pan(), jb && jb.pan()
        }
        ...
        if (!1 === a.enablePan) {
          Ua(s, -b.x + N[0], -b.y + N[1], null, c);
          var d = b.w + (b.x < 0 ? b.x : 0) + N[0],
            e = b.h + (b.y < 0 ? b.y : 0) + N[1];
          s.style.width = d + "px", s.style.height = e + "px";
          var f = 0 === d ? 0 : (b.x - N[0]) / d * 100,
            g = 0 === e ? 0 : (b.y - N[1]) / e * 100;
        ...
        var b = a.bounds || d(),
          ...
          h = b.vh / 2 - f,
          j = Ua(s);
        Ua(s, !1 !== a.horizontal ? g - c[0] : j[0], !1 !== a.vertical ? h - c[1] : j[1], null, a.doNotAnimate, function() {
          a.doNotFirePanEvent || w(!1 !== a.horizontal ? g - j[0] : 0, !1 !== a.vertical ? h - j[1] : 0, da, da), i && i.pan(), jb && jb.pan(), a.onComplete && a.onComplete()
        }, a.onStep)
        ...
        var i = function() {
          Ma(f[0] + g / 2, f[1] + h / 2), c.onComplete && c.onComplete()
        };
        this.centerContent({
          bounds: e,
        ...
        var j = da,
          k = i - da;
        Ma(e[0] + c.w / 2, e[1] + c.h / 2), this.centerOn(a, {
          onStep: function(a, b) {
            Qa(j + a / b * k)
          },
          onComplete: function() {
        ...
        return Qa(a, null, null, b, c)
      }, this.setZoomRange = function(a, b) {
        return null != a && 2 === a.length && a[0] < a[1] && null != a[0] && null != a[1] && a[0] > 0 && a[1] > 0 && (ja = a, b || (da < ja[0] || da > ja[1]) && Qa(da)), ja
      ...
      var eb = this.pan = function(a, b, c) {
        Va(s, a, b, null, c, function(a) {
          w(a[0], a[1], da, da), i && i.pan(), jb && jb.pan()
        })
      };
      this.setPan = function(a, b, c, d, e) {
        return Ua(s, a, b, null, !c, d, e)
      }, this.setTransformOrigin = function(a, b) {
        ea = [a, b], Ha()
      };
      var fb = this.calculateCumulativeScroll = function(a) {
        ...
        gb = this.calculateOffset = function(a) {
      ...
      this.mapLocation = function(a, b, c) {
        ...
        var c = Wa(),
          d = Ua(s, a - c[0], b - c[1], null, !0);
        return i && i.pan(), jb && jb.pan(), d
      }, this.applyZoomToElement = function(a, b) {
        b = b || da, Ga("transform", "scale(" + b + ")", a)
      }, this.setTransformOriginForElement = function(a, b) {
        Ga("transformOrigin", b[0] + " " + b[1], a)
      ...
      this.fixElement = function(b, c, d) {
        if (null != b) {
          ...
          hb[e] = {
            ...
            top: c.top,
            pos: d
          }, b.style.position = "absolute", b.style.left = d[0] + "px", b.style.top = d[1] + "px", s.appendChild(b), ib(e)
        }
  ...
  function() {
    ...
    c.Surface = function(a) {
      ...
      var n, o = d.getElement(a.container),
        ...
        q = !(!1 === a.elementsDraggable),
        r = !0 === a.elementsDroppable,
        s = a.dragOptions || {},
        t = a.dropOptions || {},
        u = a.stateHandle,
        ...
        C = new b.Widgets.Lasso({
          ...
          onSelect: function(a, b, c, d) {
            ...
            for (var h = 0; h < g.length; h++) null != A && !1 === A(e(g[h])) || (f.push(e(g[h])), m.jsPlumb.addToDragSelection && m.jsPlumb.addToDragSelection(g[h].el));
      ...
      }), m.jsPlumb.setContainer(p), d.addClass(o, g.SURFACE), !1 === a.enablePan && d.addClass(o, g.SURFACE_NO_PAN);
      var F = function(a, b) {
        var c = function(a) {
        ...
        if (q) {
          ...
          null != b && m.jsPlumb.extend(j, b), j[n] = e.wrap(j[n], function() {
            ...
            for (var b = function(b) {
                ...
                console.log(w,x)
                j.magnetize && !c.node.group ? c.pos = l.getLayout().setMagnetizedPosition(c.node.id, c.pos[0], c.pos[1], !0) : l.getLayout().setPosition(c.node.id, c.pos[0], c.pos[1], !0), y.positionChanged(b[0]), !1 !== v && (l.storePositionInModel({
                  id: c.node.id,
                  leftAttribute: w,
                  topAttribute: x
      ...
      this.selectEdges = function(a) {
        ...
        if (b.el) {
          ...
          l.getLayout().setSize(b.obj.getFullId(), c), l.fire(i.objectRepainted, b)
        }
        ...
        var H = m.jsPlumb.getEventManager(),
          I = new Katavorio({
            ...
            getPosition: function(a, b) {
              var c = y.calculateCumulativeScroll(a),
                d = y.calculateOffset(a);
      ...
      // console.log(a.miniview.container.children.length)
      // if(a.miniview.container.children.length > 0){
      //     a.miniview = window.myminiview
      // }else{
      //     window.myminiview = a.miniview
      // }
  ...
  function() {
    ...
    c.Miniview = function(a) {
      ...
      e.on(window, h.resize, jsPlumbToolkitUtil.debounce(function() {
        b()
      }, 100)), !1 !== a.enableWheelZoom && addWheelListener(p, J), z.setTransformOriginForElement(r, [0, 0]), e.addClass(p, f.MINIVIEW), e.on(r, h.mousedown, F), u && (w = e.createElement("div"), w.className = f.MINIVIEW_COLLAPSE, p.appendChild(w), e.on(w, g.click, function(a) {
        x = !x,
          e[x ? j.addClass : j.removeClass](p, f.MINIVIEW_COLLAPSED), K(!0)
      }));
      var K = function(a) {
      ...
      }, this.setVisible(!1 !== a.visible), this.getPan = z.getPan;
      var Q = function(a, b) {
