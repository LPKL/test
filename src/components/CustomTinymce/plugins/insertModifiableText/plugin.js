...
(function() {
  ...
  var open = function(editor) {
    var onSubmit = function() {
      return function(api) {
        ...
        // console.log('onsubmit', api.getData().modifiabletext)
        var $predom = $('<pre>').attr({ 'data-type': 'modifiable-text', 'contenteditable': true }).css({ 'backgroundColor': '#F8F8FF' }).text(api.getData().modifiabletext)
  ...
  var register$1 = function(editor) {
    editor.ui.registry.addButton('insertModifiableText', {
      icon: 'editable-text',
      text: 'Modifiable',
  ...
  function Plugin() {
    global.add('insertModifiableText', function(editor) {
