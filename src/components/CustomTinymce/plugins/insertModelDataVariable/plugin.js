...
(function(domGlobals) {
  ...
  var getEditable = function(editor, elem) {
    var isModelData = function(node) {
      if (node.title === 'modeldata_variable_type') {
        return true
      }
      return false
    }
  ...
  var register = function(editor) {
    editor.addCommand('mceModelDataVariable', function() {
      return editor.settings.get_modelattrs_callback(editor, 'modeldata_variable_type')
    })
    editor.ui.registry.addButton('insertModelDataVariable', {
      tooltip: 'Model Params Info',
      text: 'Model Params',
      icon: 'insert-data-variable',
      onAction: function() {
        // 获取模型列表
        return editor.execCommand('mceModelDataVariable')
      }
    })
    editor.ui.registry.addButton('modelparamsDataButton', {
      tooltip: 'Model Params Info',
      text: 'Model Params',
      icon: 'insert-model-data',
      onAction: function() {
        // 获取模型列表
        return editor.execCommand('mceModelData')
      }
    })
  }
  ...
  var register$1 = function(editor) {
    editor.ui.registry.addContextToolbar('insertModelDataVariable', {
      items: 'modelparamsDataButton',
  ...
  function Plugin() {
    global.add('insertModelDataVariable', function(editor) {
