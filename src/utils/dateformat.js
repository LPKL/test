...
const _longMonths = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']
const _shortDays = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat']
const _longDays = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday']
// Defining patterns
var replaceChars = {
  // Day
  d: function() { var d = this.getDate(); return (d < 10 ? '0' : '') + d },
  D: function() { return _shortDays[this.getDay()] },
  j: function() { return this.getDate() },
  l: function() { return _longDays[this.getDay()] },
  ...
  // Month
  F: function() { return _longMonths[this.getMonth()] },
  m: function() { var m = this.getMonth(); return (m < 9 ? '0' : '') + (m + 1) },
  M: function() { return _shortMonths[this.getMonth()] },
...
export default {
  dateFormat,
  install(Vue, options) {
    Object.defineProperty(Vue.prototype, '$dateFormat', dateFormat)
  }
}
